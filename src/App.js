...
import { WorkshopArtworkPage } from './pages/Workshop/WorkshopArtworkPage'
import { WorkshopSubmitPage } from './pages/Workshop/WorkshopSubmitPage'
import { Account } from './pages/Workshop/Account'
        ...
        <div className="wrapper modal-show">
          ...
          <Router>
            ...
            <Switch>
              ...
              />
              <Route exact path="/workshop/account" component={Account} />
            </Switch>
            <Footer />
          </Router>
        </div>
