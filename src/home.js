...
import './assets/css/_home-service.scss'
                        ...
                        <div className="billboard__box">
                            ...
                            <div className="billboard__content">
                                ...
                                <h1 className="billboard__title h1">
                                    Where <span>community-voted</span> ideas are crowdsourced into <span>digital artworks</span>(NFTs)!
                                </h1>
                            ...
                            <div>
                                ...
                                <div
                                    srcSet="../../assets/img/billboard/img--320x240.webp 1x, ../../assets/img/billboard/img--640x480.webp 2x"
                                    type="image/webp" media="(max-width: 360px)">
                                    <div
                                        srcSet="../../assets/img/billboard/img--320x240.jpg 1x, ../../assets/img/billboard/img--640x480.jpg 2x"
                                        media="(max-width: 360px)">

                                        <div
                                            srcSet="../../assets/img/billboard/img--728x400.webp 1x, ../../assets/img/billboard/img--1456x800.webp 2x"
                                            type="image/webp" media="(max-width: 768px)">
                                            <div
                                                srcSet="../../assets/img/billboard/img--728x400.jpg 1x, ../../assets/img/billboard/img--1456x800.jpg 2x"
                                                media="(max-width: 768px)">

                                                <div
                                                    srcSet="../../assets/img/billboard/img--1380x623.webp 1x, ../../assets/img/billboard/img--2760x1246.webp 2x"
                                                    type="image/webp">
                                                    <div
                                                        srcSet="../../assets/img/billboard/img--1380x623.jpg 1x, ../../assets/img/billboard/img--2760x1246.jpg 2x">

                                                        <div className="billboard__img"
                                                             src="../../assets/img/billboard/img--1380x623.jpg"
                                                             width="1380" height="623" loading="lazy" alt=""/></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <ul className="home-service__list">
                        ...
                        <li className="home-service__item">
                            ...
                            <p className="home-service__text">
                                Workshop for the people to design and build NFT through social voting.
                            </p>
                        ...
                        <li className="home-service__item">
                            ...
                            <p className="home-service__text">
                                Exhibition hall where you can put up your art works and regale us with your stories.
                            </p>
                        ...
                        <li className="home-service__item">
                            ...
                            <div to="/auction" className="home-service__ico">
                                <svg width="36" height="36" viewBox="0 0 36 36">
                                    <path
                                    ...
                                    <path
                                        d="M27 18.63a4.13 4.13 0 110-8.26 4.13 4.13 0 010 8.26zm0-6.75a2.63 2.63 0 100 5.25 2.63 2.63 0 000-5.25z"/>
                                    <path
                                        d="M35.25 25H.75a.75.75 0 01-.75-.75V4.75C0 4.34.34 4 .75 4h34.5c.41 0 .75.34.75.75v19.5c0 .41-.34.75-.75.75zM1.5 23.5h33v-18h-33v18z"/>
                                    <path
                            ...
                            <p className="home-service__text">
                                Auction platform where artists earn transaction fees from auctioned artworks.
                            </p>
