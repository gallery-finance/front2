...
export const DonutLightIcon = ({ width = 69, height = 69 }) => (
    <svg
    ...
    >
        <circle opacity="0.2" cx="34.5" cy="34.5" r="34.5" fill="#DC679F"></circle>
        ...
        <path
            ...
            strokeWidth="2"
        ></path>
        <circle cx="37.4264" cy="38.7479" r="3.96398" fill="#E1AFCA"></circle>
        <path
        ...
        <rect
            ...
            height="5.37998"
            rx="1.12336"
            transform="rotate(-12.2822 45.8138 38.3863)"
            fill="#DC3C45"
            stroke="#641937"
            strokeWidth="1.5"
        ></rect>
        <rect
            ...
            height="5.37998"
            rx="1.12336"
            transform="rotate(25.2453 44.6832 21.2475)"
            fill="#F3E172"
            stroke="#5C5012"
            strokeWidth="1.5"
        ></rect>
        <rect
            ...
            height="5.0179"
            rx="1.12336"
            transform="rotate(58.2284 30.1728 40.6316)"
            fill="#F3E172"
            stroke="#5C5012"
            strokeWidth="1.5"
        ></rect>
        ...
        <rect
            ...
            height="4.51081"
            rx="1.12336"
            transform="rotate(70.8822 45.2855 29.7922)"
            fill="#F3F3F8"
            stroke="#6D6A6C"
            strokeWidth="1.5"
        ></rect>
